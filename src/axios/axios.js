...
// esses reponses nao sao iguais, 1ºé a resposta da requisação, o 2º é o "acerto" resposta q deu certo
...
const sheets = {
  ...
  createEvento: (form, imagem) => {
    ...
    for (let key in form) data.append(key, form[key]); //posso usar chaves ou nao
    if (imagem) data.append("imagem", imagem); //essa é uma forma de se economizar linhas
